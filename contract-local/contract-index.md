...
| 契約 | 用途 |
|---|---|
| [hmiIntf自訂角色尺度與美術規範](hmiIntf自訂角色尺度與美術規範.md) | 紙娃娃 rig、角色自然尺度、可玩角色 base 分層、四位公主多維度辨識差異與正式美術資產規範（自 README ch2.7 拆出，issue #123 補入 base 分層，issue #130 補入 roster 辨識度） |
