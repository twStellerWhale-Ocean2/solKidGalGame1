...
export function createElements() {
  return {
    ...
    characterHomeCard: $("#characterHome .account-select-card"),
    characterHomeAccountLine: $("#characterHomeAccountLine"),
    characterHomeList: $("#characterHomeList"),
    characterHomeLogout: $("#characterHomeLogout"),
    characterHomeAdd: $("#characterHomeAdd"),
