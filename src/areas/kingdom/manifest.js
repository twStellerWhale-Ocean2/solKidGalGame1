...
export const kingdomArea = Object.freeze({
  ...
  locations: [
    ...
    { id: "market", area: "kingdom", node: "market", label: "Market Square", icon: "🥖", npc: "Auntie Pom", scene: "scene-market", npcImage: npcImage("auntie-pom-market"), hint: "The market has warm bread and food words. Furniture is no longer sold here." },
...
export const kingdomSceneConfigs = Object.freeze({
  ...
  market: { scene: "scene-market", npc: "Auntie Pom", npcImage: npcImage("auntie-pom-market"), travelAction: "Visit", travelLine: "Auntie Pom's market is for bread and food words now. Furniture is gone from the shop loop." },
