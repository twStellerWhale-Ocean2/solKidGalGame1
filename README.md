...
- **時長鎖定（家長管控）**：`⋮` → 「時長覆寫與鎖定」，對單一帳號設定強制的遊玩／休息時長並鎖定，孩子端的時長設定會變唯讀；孩子正在玩時也會在下一次自動存檔時套用新時長。解除鎖定後，孩子原本自己調的時長會恢復、不會被洗掉。
...
- **開放新帳號註冊**：全家帳號都建好後可以關掉，陌生人拿到網址也無法註冊；關閉後登入畫面不再顯示「建立新帳號」，既有帳號不受影響。孩子端看到的說明：
