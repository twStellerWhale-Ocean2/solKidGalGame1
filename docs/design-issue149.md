...
格式示意（取代 `Pick the friendly hello.` 等）：

```
opening EN: Nami says, "Good morning, Princess. The sea is calm today."
opening ZH: 娜米說：「早安，公主。今天海面很平靜。」
...
格式示意（取代 `How many fish are there?` 等考題）：

```
opening EN: Nami says, "Princess, this box has four fish, and that box has two fish. Please help me count all the fish."
opening ZH: 娜米說：「公主，這個箱子有四條魚，那個箱子有兩條魚。請你幫我計算一共有幾條魚。」
...
## Chat（2 題）
opening              EN：角色邀請公主聊天。  ZH：中文。
Q1/Q2 prompt         EN：角色對公主說話。  ZH：中文。
       A/B           EN：公主回應選項。   ZH：中文。   Answer：A 或 B

## Work（3 題）
opening              EN：角色向公主提出工作請求。  ZH：中文。
Q1/Q2/Q3 prompt      EN：角色提出具體任務／請求／提醒。  ZH：中文。
