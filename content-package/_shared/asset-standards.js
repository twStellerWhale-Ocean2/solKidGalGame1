...
// 資產 lint（data-audit selftest，intTest#48）據此驗證每張圖像資產之像素尺寸與檔案位元組（檔重），
...
//
// 新增資產類別須先於本表登記方納入（intTest#48 對未涵蓋類別報錯，杜絕漏網）。
...
// 仍應歸 characterBase 而非 wardrobeThumb）。回傳 null＝未涵蓋類別（intTest#48 報錯）。
