...
const ruralLessonBank = Object.freeze({
  ...
  villageHome: {
    ...
    questions: [
      ...
      { questionType: "sentence-choice", prompt: "You helped me today. Please tell me if you can help again tomorrow.", promptZh: "你今天幫了我。請告訴我你明天是否還能再幫忙。", answer: "Of course, I will help you again tomorrow.", choices: ["Of course, I caught the porch yesterday.","Of course, I must put apples in the basket.","Of course, I will help you again tomorrow."], choicesZh: ["當然，我昨天捕到門廊。","當然，我必須把蘋果放進籃子裡。","當然，我明天會再幫你。"], reward: jobReward }
    ]
  }
});
//#endregion 場景自帶題庫
