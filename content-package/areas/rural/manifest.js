...
export const ruralSceneConfigs = mergeLessons(mergeLessons({
  ...
  workwearStall: { ...ruralShopArt("workwear-stall"), scene: "scene-rural-workwear-stall", npc: "Workwear Keeper", npcImage: npcImage("workwear-stall-keeper"), npcNaturalHeightCm: 168, travelAction: "Shop", travelLine: "Hello, Princess. I brought the countryside wardrobe today.", travelLineZh: "你好，公主。我今天帶來了鄉村服飾。", shopGreeting: "Pick a kerchief hairstyle, apron dress, wooden shoes, or a warm country accessory.", shopGreetingZh: "選一款頭巾髮型、圍裙裙裝、木鞋或溫暖的鄉村配件吧。" },
