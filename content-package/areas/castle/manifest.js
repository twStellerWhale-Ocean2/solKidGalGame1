...
export const castleSceneConfigs = mergeLessons(mergeLessons({
  ...
  castleSeamstress: { ...castleShopArt("castle-seamstress"), scene: "scene-castle-seamstress", npc: "Seamstress Bea", npcImage: npcImage("castle-seamstress"), npcNaturalHeightCm: 158, travelAction: "Shop", travelLine: "Good morning, Princess. The royal court wardrobe is ready.", travelLineZh: "早安，公主。宮廷服飾已經準備好了。", shopGreeting: "Pick royal hair, a court gown, satin shoes, or a shining accessory, Princess.", shopGreetingZh: "公主，選一款宮廷髮型、禮服、緞面鞋或閃亮配件吧。" },
