...
export const wildArea = Object.freeze({
  ...
  locations: [
    ...
    { id: "fairyAtelier", area: "wild", node: "fairyAtelier", label: "Fairy Atelier", icon: "👗", npc: "Faye", scene: "scene-wild-fairy-atelier", npcImage: npcImage("fairy-atelier"), shopCategories: ["dresses", "shoes", "accessories"], defaultCategory: "dresses", hint: "Faye now tailors the whole wild wardrobe — dresses, accessories and boots." },
