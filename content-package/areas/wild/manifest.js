...
export const wildArea = Object.freeze({
  ...
  locations: [
    ...
    { id: "fairyAtelier", area: "wild", node: "fairyAtelier", label: "Fairy Atelier", icon: "👗", npc: "Faye", scene: "scene-wild-fairy-atelier", npcImage: npcImage("fairy-atelier"), shopCategories: ["outfit", "shoes", "accessories"], defaultCategory: "outfit", hint: "Faye now tailors the wild wardrobe — outfits, accessories and boots." },
