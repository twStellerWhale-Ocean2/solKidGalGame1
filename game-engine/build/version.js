...
export const versionHistory = [
  { version: "0.52.3", buildDateTime: "2026-06-21", summaryZh: "移除 ADV 公主立繪腳底的橢圓接地圓盤（.avatar-shadow）：該扁橢圓既被讀為「腳步圓盤」、又在施了深灰投影的合成 stage 內被再模糊成糊化光暈；接地改全由簡潔深灰立體投影承擔，徹底落地 #207 去圓盤去光暈意圖" },
