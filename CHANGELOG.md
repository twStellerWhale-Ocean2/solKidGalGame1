...
## 0.78.2 — 2026-07-18
- fix (#401): 選角色頁三處修正：①「檢視資訊」與「刪除」展開面板原會與角色列重疊（版面破圖），改為換行至整列下方正常顯示；②刪除公主的按鈕現在每一位公主都看得到（原本只剩一位時整顆藏起來），只剩一位時點刪除會說明「這是你唯一的公主，要先新增另一位才能移除」；③遊戲畫面左上「換公主」按鈕由循環箭頭圖示改為離開（門）圖示，更貼近「離開遊戲回選角色頁」之意
